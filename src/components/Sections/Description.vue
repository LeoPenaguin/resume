  ...
  <div class="section" id="description">
    <div class="section-center">
      ...
      <div class="social-grid">
        ...
        <a class="grid-item item-linkedin" target="_blank"
          href="https://fr.linkedin.com/pub/l%C3%A9o-penaguin/a6/7a/b14">
          <span>
      ...
      <div class="description-container">
        ...
        <div class="description-item">
          ...
          <ul>
            <li>Unit tests</li>
            <li>Software architecture : MVC (Model–view–controller), OOP (Object-oriented programming)</li>
            <li>Continuous integration : Jenkins, Github actions</li>
            <li>Team work</li>
