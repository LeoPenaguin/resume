export default {
    description: {
        ...
        tests: '🔎 Test unitaire',
        architecture:
            'Architecture logicielle : MVC (Modèle-vue-contrôleur), OOP (Programmation orientée objet)',
        Continuous: '🐙 Intégration continue : Jenkins, Github actions',
        team: 'Travail en équipe',
        agile: 'Le travail avec la méthodologie Agile',
        english: 'Anglais technique et professionel',
    },
    school: {
