...
export const useExperienceStore = defineStore("experience", () => {
  const experiences = ref<Experience[]>([
    createExperience(
      ...
      [
        skill.vue, skill.nuxt, skill.typescript, skill.vite, skill.pinia, skill.tailwind,
        skill.figma, skill.cypress, skill.playwright, skill.aws, skill.kubernetes,
        skill.terraform, skill.gha, skill.github, skill.git, skill.scrumEvents, skill.eslint,
      ],
      true,
    ),
    createExperience(
    ...
    createExperience(
      ...
      [
        skill.vue, skill.angular, skill.php, skill.symfony,
        skill.go, skill.wordpress, skill.github, skill.jenkins,
        skill.git, skill.scrumEvents, skill.phpUnit,
      ],
      true,
    ),
    createExperience(
